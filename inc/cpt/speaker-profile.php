...
function speekr_register_speaker_profile_cpt() {
	$labels = array(
		'name'               => __( 'Speakers', 'speekr' ),
		'singular_name'      => __( 'Speaker', 'speekr' ),
		'menu_name'          => __( 'Speakers', 'speekr' ),
		'add_new'            => __( 'New Speaker', 'speekr' ),
		'add_new_item'       => __( 'Add New Speaker', 'speekr' ),
		'edit_item'          => __( 'Edit Speaker', 'speekr' ),
		'new_item'           => __( 'New Speaker', 'speekr' ),
		'view_item'          => __( 'View Speaker', 'speekr' ),
		'search_items'       => __( 'Search Speakers', 'speekr' ),
		'not_found'          => __( 'No speakers found', 'speekr' ),
		'not_found_in_trash' => __( 'No speakers found in Trash', 'speekr' ),
		'all_items'          => __( 'All Speakers', 'speekr' ),
	);

	$args = array(
		'label'             => __( 'Speaker', 'speekr' ),
		'labels'            => $labels,
		'public'            => true,
		'show_ui'           => true,
		'show_in_rest'      => true,
